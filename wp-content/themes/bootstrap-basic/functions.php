...
if (!function_exists('bootstrapBasicEnqueueScripts')) {
	...
	function bootstrapBasicEnqueueScripts() 
	{
		...
		wp_enqueue_script('jquery');
		// wp_register_script('validate-script', get_template_directory_uri() . '/js/vendor/jquery.validate.js', array('jquery') ); 
		wp_enqueue_script( 'ajax-loader-script', get_stylesheet_directory_uri() . '/js/ajax-loader.js', array( 'jquery' ), '1.0.0' );

		//Define Global variables and ajax url
		wp_enqueue_script( 'bootstrap-basic-script', get_stylesheet_directory_uri() . '/js/main.js', array( 'jquery' ), '1.0.1', 1);
		wp_localize_script( 'bootstrap-basic-script', 'ajax_object', array( 'siteurl' => get_option('siteurl'), 'ajax_url' => admin_url( 'admin-ajax.php' ) )); 
		wp_enqueue_script( 'bootstrap-basic-script' );
...
/**
 * admin page displaying help. This menu in Appearance->Theme Help
 */
if (is_admin()) {
